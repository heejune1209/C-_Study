namespace Lambda
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Item item = FindItem(IsWeapon); // delegate를 이용
            ...
            // 2. 람다식 사용
            //Item item2 = FindItem((Item i) => { return i.ItemType == ItemType.Weapon; });
            ...
            // 익명 함수를 람다식으로 정의할 수도 있다. (익명 함수의 매개변수 선언) => { 익명함수 내용 } 으로 만들 수 있다. 이게 람다식이다!
